...
export const Answer: FC<AnswerProps> = ({ searchQuery, answer, done, onReset }) => {
  ...
  <div className="flex flex-col max-w-[800px] space-y-4 py-16 px-8 sm:px-24 sm:pt-16 pb-2">
    <div className="overflow-auto text-2xl sm:text-4xl">{searchQuery.query}</div>

    <div className="border-b border-zinc-800 pb-4">
      <p className="text-md text-blue-500">Sample Advertisement</p>
      <div id="demo-clarity-chat-ad-infeed"></div>
      <p className="text-md text-blue-500">Sample Chat Output</p>
  ...
  <div className="max-w-[800px] space-y-4 py-16 px-8 sm:px-24 sm:pt-16 pb-32">
    <div id="clarity-demo-chat-ad" className="ad h-full w-full border-b border-zinc-800 pb-4">
    </div>
  </div>
</div>
