      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="max-w-[1070px] mx-auto px-5 py-10">
          ...
          <article>
            ...
            <div className="flex justify-center w-screen relative left-1/2 -translate-x-1/2 overflow-x-hidden overflow-y-hidden text-lg text-gray-700 my-10 bg-gray-100 p-5 rounded-lg">
              <iframe
                srcDoc={`
