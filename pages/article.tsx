...
<body>
  <div class="container">
    <div class="image-panel">
      <img src="/api/placeholder/250/250" alt="Ultra Trail Mont Blanc" id="mainImage">
                ...
                srcDoc={`
                  ...
                  <html>
                    ...
                    <body>
                      <div class="container">
                        <div class="image-panel">
                          <img src="https://i.imgur.com/Tk7jD7k.png" id="mainImage">
                          <button class="add-to-cart" id="addToCartBtn">Add to Cart</button>
                        </div>
                        ...
                        <div class="interactive-panel">
                          <div class="chat-container" id="chatContainer">
                            <div class="chat-message visible">
                              Conquer Your Next Race with Marmot
                            </div>
                            <div class="chat-message visible">
                             Gear up for peak performance with Marmot's high-quality outdoor apparel & equipment. Ultra-tested gear for Alps or your own trail.
                            </div>
                          </div>
